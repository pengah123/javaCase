...
<head>
    ...
    <script type="text/javascript">
        function refreshCode() {
            ...
            img.src = "${pageContext.request.contextPath}/CheckCodeImg?time=" + new Date().getTime();
        }
    </script>
</head>
<body>
    ...
    <form action="${pageContext.request.contextPath}/loginServlet" method="post">
        ...
        <div class="form-inline">
            ...
            <input type="text" name="verifycode" class="form-control" id="verifycode" placeholder="请输入验证码"
                   style="width: 120px;"/>
            <a href="javascript:refreshCode()"><img src="${pageContext.request.contextPath}/CheckCodeImg"
